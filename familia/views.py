...
def agregar_familia(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(reverse("index_familia"))
...
def borrar_familia(request, identificador):
    '''
    TODO: agregar un mensaje en el template index.html que avise al usuario que 
...
def actualizar_familia(request, identificador=''):
    '''
